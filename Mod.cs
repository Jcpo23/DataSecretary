...
namespace DataSecretary
{
    ...
    {
        public static ILog log = LogManager.GetLogger($"{nameof(DataSecretary)}.{nameof(Mod)}").SetShowsErrorsInUI(false);
        ...
        public static readonly string Id = "DataSecretary";
        ...
        public void OnLoad(UpdateSystem updateSystem)
        {
            ...
            AssetDatabase.global.LoadSettings(nameof(DataSecretary), m_Setting, new Setting(this));

            updateSystem.UpdateAt<DataSecretary.DSBuildListSystem>(SystemUpdatePhase.UIUpdate);
        }
